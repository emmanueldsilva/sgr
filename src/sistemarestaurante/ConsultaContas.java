...
public class ConsultaContas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pesquisarLabel.setText("Pesquisar pela Data e Hor�rio em que a Conta foi efetuada:");
        ...
        horarioAtendimentoLabel.setText("Hor�rio de Atendimento: ");

        horarioAtendimentoComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Almo�o", "Janta" }));
        ...
        contasTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "N�mero da Conta", "Hor�rio de Fechamento", "N�mero de Pessoas", "Hor�rio de Atendimento"
            }
        ) {
