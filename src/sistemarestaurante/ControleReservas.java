...
public class ControleReservas
{
    ...
    public void validaDadosCliente()
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "Erro! Voc� n�o digitou o nome do cliente!", 
                    "Erro!", JOptionPane.ERROR_MESSAGE);
        }
        else if (menuReservas.getTelefoneCliente().equals("(  )    -    "))
        {
            JOptionPane.showMessageDialog(null, "Erro! Voc� n�o digitou o telefone do cliente!", 
                    "Erro!", JOptionPane.ERROR_MESSAGE);
        }
        else{
    ...
    public void validaDadosReserva()
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "Erro! Voc� n�o selecionou o cliente da reserva! \n" +
                    "Verifique se o campo 'Cliente Selecionado para a Reserva' est� sem preenchimento.", 
                    "Erro!", JOptionPane.ERROR_MESSAGE);
        }
        else if (menuReservas.getNumeroPessoasReserva() == 0)
        {
            JOptionPane.showMessageDialog(null, "Erro! Voc� n�o digitou n�mero de pessoas da reserva!", 
                    "Erro!", JOptionPane.ERROR_MESSAGE);
        }
        else if (menuReservas.getTipoReserva().equals(""))
        {
            JOptionPane.showMessageDialog(null, "Erro! Voc� n�o selecionou o tipo da reserva!", 
                    "Erro!", JOptionPane.ERROR_MESSAGE);
        }
        else if (menuReservas.getDataReserva().equals(""))
        {
            JOptionPane.showMessageDialog(null, "Erro! Voc� n�o digitou a data da reserva!", 
                    "Erro!", JOptionPane.ERROR_MESSAGE);
        }
        else if (menuReservas.getHorarioReserva().equals(""))
        {
            JOptionPane.showMessageDialog(null, "Erro! Voc� n�o digitou o hor�rio da reserva!", 
                    "Erro!", JOptionPane.ERROR_MESSAGE);
        }
        else
        {
